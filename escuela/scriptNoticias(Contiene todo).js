...
botonesVerMas.forEach((boton) => {
    ...
    boton.addEventListener('click', (evento) => {
        ...
        // Evita que el enlace "#" lleve la página hacia arriba
        evento.preventDefault();

        // Buscamos la tarjeta correspondiente
        const noticia = boton.closest('.noticia');

        // Abrimos o cerramos la tarjeta
        const estaExpandida = noticia.classList.toggle('expandida');
